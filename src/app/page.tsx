...
//               </span>
//               <span className='mt-2 text-zinc-700'>
//                 It&apos;s that simple. Try out AskPdf today -
...
export default function Home() {
  return (
    <>
      {/* <div className='mx-auto w-full max-w-screen-xl px-2.5 md:px-20 mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'> */}
      <div className='ml-16 px-2.5 mt-44 mb-44 md:px-0 sm:flex flex-col items-start justify-center w-auto bg-image bg-cover bg-center' style={{ backgroundImage: `url('./forbes-924140_1280.jpg')` }}>
        ...
        <h1 className='max-w-4xl text-5xl font-bold md:text-5xl lg:text-7xl'>
          Your PDFs,{' '}
          <span>Your Personal</span>{' '}
          <span className='text-green-600 animate-pulse'>Assistant.</span>
        </h1>

        <p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
          AskPdf turns your PDFs into interactive chatbots. Ask questions, get answers instantly.
        </p>
        ...
        <div className='relative isolate'>
          ...
          <div
            ...
            <div
              ...
              className='relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#7af67c] to-[#2fa55e] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]'
            />
          </div>
        </div>
      </div>
      ...
      <div className='mx-auto mb-32 mt-32 max-w-5xl sm:mt-56'>
        <div className='mb-12 px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl sm:text-center'>
            <h2 className='mt-2 font-bold text-4xl text-gray-900 sm:text-5xl'>
              {/* Start chatting in minutes */}
              {/* In just a few minutes, begin conversing */}
              Dive into a conversation <span className='underline text-green-600 decoration-black decoration-solid animate-pulse'>now</span>
            </h2>
            <p className='mt-4 text-lg text-gray-600'>
              {/* Chatting to your PDF files has never been
              easier than with AskPdf. */}
              AskPdf makes it easier than ever to have a conversation with your PDF files.
            </p>
          </div>
        </div>

        {/* steps */}
        <ol className='flex-col my-8 space-y-4 pt-8 md:flex md: md:space-y-0 sm:mx-5'>
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                ...
                <Link
                  href='/pricing'
                  className='text-green-600 decoration-black text-lg underline underline-offset-2'>
                  pro plan
                </Link>
                .
              </span>
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='text-xl font-semibold'>
                Put your PDF file online.
              </span>
              <span className='mt-2 text-zinc-700'>
                Your file will be processed and prepared for you to chat with.
              </span>
            </div>
          </li>
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                It&apos;s  straightforward. Experience AskPdf today -
                it's incredibly quick, takes less than a minute.
              </span>
            </div>
          </li>
        </ol>
